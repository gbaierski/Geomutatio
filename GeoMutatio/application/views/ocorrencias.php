...
include('header.php');
    ...
    $this->Ocorrencia_model->deletaOcorrenciaFalsa();
    $this->Ocorrencia_model->atualiza_curtidas();
    $this->Ocorrencia_model->deletaOcorrenciaFalsa();
    $this->Ocorrencia_model->atualizaImagemOcorrencia();
...
?>
   ...
   <!-- Make sure you put this AFTER Leaflet's CSS -->
        <h1 id="mapa_title" style="margin-top: 5%; margin-left: 38%; font-size: 2.5vw;">Mapa de Ocorrências</h1>
    <div class="clear"></div>


   <h5 style="margin-left:80%; margin-top:-1%;"> Filtrar por: </h5>
    <form method="post">
        <select name="filtro_ocorrencia" style="float:left; margin-left:80%; height:2em; width: 13vw;">
            <option value="sem">Sem filtro</option style="font-size: 1.2vw;"> 
            <option value="buraco">Buraco</option> 
            <option value="alagamento">Alagamento</option>
            <option value="deslizamento">Deslizamento de terra</option>
            <option value="arvore">Árvore caída</option>
        </select>
        <input type="submit" style="width: 5vw; cursor:pointer; margin-left:0.1%; font-size: 1.2vw; color: #fff;background-color: #28a745; border-color: #28a745; display: inline-block; border: 1px solid transparent; padding: .13rem .45rem; border-radius:.18rem;" value="Filtrar">
    </form>
        ...
        if ($filtro == $tipo_ocorrencia) {
            ...
            <script type="text/javascript">
                ...
                <?php if ($this->session->userdata('usuario')) { 
                    ...
                    $testeSeta = $this->Ocorrencia_model->atualizaSetas($usuarioLogado,$id_ocorrencia);
                    ...
                    if ($testeSeta == 'like') {
                        ...
                        var marker = L.marker([local1, local2],{icon: icone}).addTo(mymap); marker.bindPopup("<b style='color:#54b07b;'><?php echo $nome_ocorrencia;?></b><br>" + "<b style='color: #8e8e8e; font-size:10px;'><img style='width:2em;'  src='<?= base_url();?>/assets/imagens/icons/date.png'><?php echo $data_ocorrencia;?></b><br> <a href='<?='../Ocorrencia/deslikeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:17%;'  src='<?= base_url();?>/assets/imagens/setas/setavermelhacinza.png'></a><a href='<?='../Ocorrencia/likeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:15%;'  src='<?= base_url();?>/assets/imagens/setas/setaverde.png'></a>").openPopup();

                        <?php
                    }elseif ($testeSeta == 'deslike') {

                        ?>

                        var marker = L.marker([local1, local2],{icon: icone}).addTo(mymap); marker.bindPopup("<b style='color:#54b07b;'><?php echo $nome_ocorrencia;?></b><br>" + "<b style='color: #8e8e8e; font-size:10px;'><img style='width:2em;'  src='<?= base_url();?>/assets/imagens/icons/date.png'><?php echo $data_ocorrencia;?></b><br> <a href='<?='../Ocorrencia/deslikeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:17%;'  src='<?= base_url();?>/assets/imagens/setas/setavermelha.png'></a><a href='<?='../Ocorrencia/likeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:15%;'  src='<?= base_url();?>/assets/imagens/setas/setaverdecinza.png'></a>").openPopup();
                        ...
                        var marker = L.marker([local1, local2],{icon: icone}).addTo(mymap); marker.bindPopup("<b style='color:#54b07b;'><?php echo $nome_ocorrencia;?></b><br>" + "<b style='color: #8e8e8e; font-size:10px;'><img style='width:2em;'  src='<?= base_url();?>/assets/imagens/icons/date.png'><?php echo $data_ocorrencia;?></b><br> <a href='<?='../Ocorrencia/deslikeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:17%;'  src='<?= base_url();?>/assets/imagens/setas/setavermelhacinza.png'></a><a href='<?='../Ocorrencia/likeOcorrencia/'.$id_ocorrencia;?>/'> <img style='width:1.5em; margin-left:15%;'  src='<?= base_url();?>/assets/imagens/setas/setaverdecinza.png'></a>").openPopup();
